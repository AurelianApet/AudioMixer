...
namespace NAudio.Dmo
{
    ...
    public class MediaObjectInPlace : IDisposable
    {
        ...
        {
            IMediaObjectInPlace cloneObj;
            Marshal.ThrowExceptionForHR(this.mediaObjectInPlace.Clone(out cloneObj));
        ...
        {
            long latencyTime;
            Marshal.ThrowExceptionForHR(this.mediaObjectInPlace.GetLatency(out latencyTime));
            return latencyTime;
        }
