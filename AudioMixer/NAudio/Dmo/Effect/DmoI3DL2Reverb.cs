    ...
    public class DmoI3DL2Reverb : IDmoEffector<DmoI3DL2Reverb.Params>
    {
        ...
        public struct Params
        {
            ...
            public int Quality
            {
                ...
                {
                    int quality;
                    Marshal.ThrowExceptionForHR(fxI3Dl2Reverb.GetQuality(out quality));
                    return quality;
                }
            ...
            {
                uint preset;
                Marshal.ThrowExceptionForHR(fxI3Dl2Reverb.GetPreset(out preset));
            ...
            private DsFxI3Dl2Reverb GetAllParameters()
            {
                ...
                Marshal.ThrowExceptionForHR(fxI3Dl2Reverb.GetAllParameters(out param));
                return param;
            }
        }
