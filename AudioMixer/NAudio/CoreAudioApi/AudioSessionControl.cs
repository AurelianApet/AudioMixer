...
namespace NAudio.CoreAudioApi
{
    ...
    public class AudioSessionControl : IDisposable
    {
        ...
        public AudioSessionControl(IAudioSessionControl audioSessionControl)
        {
            ...
            if (audioSessionControlInterface is IAudioMeterInformation)
            {
                IAudioMeterInformation meters = (IAudioMeterInformation)audioSessionControlInterface;
                AudioMeterInformation = new AudioMeterInformation(meters);
            }
            if (audioSessionControlInterface is ISimpleAudioVolume) {
                ISimpleAudioVolume volume = (ISimpleAudioVolume)audioSessionControlInterface;
