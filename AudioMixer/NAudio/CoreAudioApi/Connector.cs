    ...
    public class Connector
    {
        ...
        public ConnectorType Type
        {
            get
            {
                ...
                connectorInterface.GetType(out result);
                return result;
            }
        }
        ...
        public DataFlow DataFlow
        {
            ...
            {
                DataFlow result;
                connectorInterface.GetDataFlow(out result);
                return result;
            }
        }
        ...
        public bool IsConnected
        {
            ...
            {
                bool result;
                connectorInterface.IsConnected(out result);
                return result;
            }
        }
        ...
        public Connector ConnectedTo
        {
            ...
            {
                IConnector result;
                connectorInterface.GetConnectedTo(out result);
        ...
        public string ConnectedToConnectorId
        {
            ...
            {
                string result;
                connectorInterface.GetConnectorIdConnectedTo(out result);
                return result;
            }
        }
        ...
        public string ConnectedToDeviceId
        {
            ...
            {
                string result;
                connectorInterface.GetDeviceIdConnectedTo(out result);
                return result;
            }
        }
    }
